# settings -> oben rechts settings(JSON) -> autoDocstring
# """ + Enter für automatisches erstellen 
# Numpy Style -> Tap wechselst zum nächsten [ description ]

# nur wichtiges bzw. "Dinge" die oft verwendet werden kommentieren
