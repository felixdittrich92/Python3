# benötigt pip mypy 
# ändert nichts am Programmablauf ist nur Doku ...
# wird in Bibliotheken bzw. dessen Erstellung verwendet -> nicht in kleinen / eigenen Projekten verwenden
...
class Vector2D:
    ...
    def __call__(self) -> str: # return type ist String
